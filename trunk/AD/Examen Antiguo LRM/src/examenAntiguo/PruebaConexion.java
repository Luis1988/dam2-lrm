...
public class PruebaConexion {
	...
	public static void menuNavegacion(){
		System.out.println("______________________________");
		System.out.println();
		System.out.println("1. Siguiente");
		System.out.println("2. Anterior");
		System.out.println("3. Primero");
		System.out.println("4. Último");
	...
	public static void main(String[] args) throws ClassNotFoundException, SQLException {
		...
		while(salir1 == false){
			...
			case 5:
				...
				boolean salirNav = false;
				while(!salirNav){
					int opNav = 0;
					while(opNav < 1 || opNav > 5){
						menuNavegacion();
						opNav = teclado.nextInt();
						System.out.println();
					}
					switch(opNav){
					case 1:
