...
public class EjercicioPersona extends JFrame {
	...
	private JRadioButton rdbtnBorrar, rdbtnInsertar;
	...
	public EjercicioPersona() {
		...
		rdbtnBorrar = new JRadioButton("Borrar");
		...
		btnRealizarOperacin.addActionListener(new ControladorBoton(this));
		rdbtnInsertar.setSelected(true);
		
		contentPane.addFocusListener(new ControladorBoton(this));
	}
	...
	public boolean isInsertar(){
		return rdbtnInsertar.isSelected();
	}

	public boolean isBorrar() {
		return rdbtnBorrar.isSelected();
	}
